...
the latest full update for the given CHANNEL.
    ...
    <key>Identifier</key>
    <string>com.github.cospit.munki.MSEdge</string>
    ...
    <string>com.github.cospit.download.MSEdge</string>
    <key>Process</key>
    <array>
        <dict>
            <key>Comment</key>
            <string>Merge input pkginfo and additional_pkginfo generated by MSOfficeMacURLandUpdateInfoProvider</string>
            <key>Processor</key>
